return {
	...
	config = function()
		...
		key.set("n", "<leader>bo", "<cmd>BufferLineCloseOthers<cr>", opts("Close Outher Buffers"))
		key.set("n", "<leader>bl", "<cmd>BufferLineCloseRight<cr>", opts("Close All Buffers in Right"))
		key.set("n", "<leader>bh", "<cmd>BufferLineCloseLeft<cr>", opts("Close All Buffers in Left"))
